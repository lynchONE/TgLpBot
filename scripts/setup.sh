...
echo -e "  2. Deploy the Zap contract to BSC"
echo -e "  3. Update ZAP_CONTRACT_ADDRESS in .env"
echo -e "  4. Run the bot with: ${GREEN}make run${NC}"
echo ""
echo -e "${YELLOW}Useful commands:${NC}"
echo -e "  Build:            ${GREEN}make build${NC}"
echo -e "  Run:              ${GREEN}make run${NC}"
echo -e "  Test:             ${GREEN}make test${NC}"
echo -e "  Deploy:           ${GREEN}./scripts/deploy.sh${NC}"
echo ""
