...
export const DEFAULT_LIQUIDITY_CHART_THEME = {
...
export default function LiquidityDistributionChart({
    ...
    handleHitPx = DEFAULT_HANDLE_HIT_PX,
    theme = DEFAULT_LIQUIDITY_CHART_THEME,
    token0Decimals = 18,
    token1Decimals = 18,
    invertPrice = false,
    loading = false,
    ...
    const colors = useMemo(() => ({ ...DEFAULT_LIQUIDITY_CHART_THEME, ...theme }), [theme]);
            ...
            {hoveredBin?.bin ? (() => {
                ...
                return (
                    <div style={{
                        ...
                        fontSize: 11, lineHeight: 1.5, color: colors.tooltipText,
                        pointerEvents: 'none', zIndex: 30,
                    }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline' }}>
                            <span style={{ color: colors.tooltipMuted }}>价格区间</span>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 4 }}>
                            <span style={{ color: colors.tooltipMuted }}>流动性</span>
                            <span style={{ fontFamily: 'ui-monospace, SFMono-Regular, monospace', color: colors.tooltipValue, fontWeight: 700 }}>{usdText}</span>
                        </div>
                    </div>
                );
            })() : null}
    ...
    return (
        <div
            style={{
                ...
                left: x - handleHitPx / 2, width: handleHitPx,
