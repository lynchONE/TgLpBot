## 1. 规范
- [x] 1.1 为聪明钱 / 用户资产的本地转账事件持久化、钱包详情 / 盈亏日历本地聚合读取、净转账剔除口径补充 spec delta
...
- [x] 2.4 新增 `UserWalletTransferEvent` 模型与按用户聚合读取 helper，供“我的资产”本地剔除充提影响
...
- [x] 5.4 更新 MiniApp / webapp 的转账展示，改为单条净转账摘要并修正文案
