// Smart Money follow config API proxy
// Forwards requests to backend: GET/POST /api/smart_money_follow_config
...
export default async function handler(req, res) {
    ...
    const url = `${backendBaseUrl}/api/smart_money_follow_config${method === 'GET' ? buildQueryString(req.query) : ''}`;
