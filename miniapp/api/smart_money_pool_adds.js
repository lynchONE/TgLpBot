// Smart Money pool adds details API proxy
// Forwards requests to backend: GET /api/smart_money_pool_adds
...
export default async function handler(req, res) {
    ...
    const url = `${backendBaseUrl}/api/smart_money_pool_adds${buildQueryString(req.query)}`;
