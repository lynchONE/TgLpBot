        ...
        <div className={`mt-3 rounded-2xl border border-zinc-200 bg-white/40 backdrop-blur-md p-3.5 shadow-sm dark:border-white/5 dark:bg-[#16181c] dark:shadow-none ${className}`.trim()}>
            <div className="flex items-center justify-between gap-3">
                <div className="flex min-w-0 flex-col justify-center">
                    <div className="truncate text-[14px] font-extrabold leading-tight text-zinc-900 dark:text-white/95">{title}</div>
                    {subtitle ? (
                        <div className="mt-0.5 truncate text-[10px] text-zinc-500 dark:text-white/40">{subtitleNode}</div>
                    ) : null}
                </div>
