...
export default function SmartMoneyWalletPositionsModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4">
            ...
            <div className="relative w-full max-w-lg overflow-hidden rounded-t-2xl sm:rounded-2xl border border-zinc-200 bg-white shadow-2xl dark:border-white/10 dark:bg-[#111318] flex flex-col h-[92vh] sm:h-[720px]">
                ...
                <div className="flex-1 overflow-auto p-4">
                    ...
                    {!loading && !error && positions.length === 0 ? (
                        <div className="mt-3 rounded-xl border border-zinc-200 bg-white/70 p-3 text-[11px] text-zinc-500 dark:border-white/10 dark:bg-white/5 dark:text-white/60">
                            该钱包当前无活跃 LP 仓位
                        </div>
                    ) : null}
                    ...
                    {positions.length ? (
                        <div className="mt-3 space-y-2">
                            {positions.map((p) => {
                                ...
                                return (
                                    <div key={`${version}:${poolId}:${positionId}`} className="rounded-2xl border border-zinc-200 bg-white/70 p-3 dark:border-white/10 dark:bg-white/5">
