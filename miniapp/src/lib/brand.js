...
const BRAND_THEMES = {
    lime: {
        ...
        actionPillButtonClass: 'inline-flex items-center gap-1.5 rounded-md border border-[#b7ff1a]/36 bg-[#b7ff1a]/12 px-3 py-1 text-[10px] font-semibold leading-none text-[#d9ff63] shadow-none transition hover:bg-[#b7ff1a] hover:text-[#050700] disabled:cursor-not-allowed disabled:opacity-50',
    ...
    emerald: {
        ...
        actionPillButtonClass: 'inline-flex items-center gap-1.5 rounded-md border border-[#9cff00]/36 bg-[#9cff00]/12 px-3 py-1 text-[10px] font-semibold leading-none text-[#9cff00] shadow-none transition hover:bg-[#9cff00] hover:text-[#050700] disabled:cursor-not-allowed disabled:opacity-50',
