...
func TestCalcV4UnclaimedFeesFromGrowthsHandlesWrappedLastGrowth(t *testing.T) {
	pos := &blockchain.V4PositionInfo{
		TickLower:                100,
		TickUpper:                200,
		Liquidity:                big.NewInt(2),
...
func TestCalcV4UnclaimedFeesFromGrowthsAllowsWrappedInsideValue(t *testing.T) {
	pos := &blockchain.V4PositionInfo{
		TickLower:                100,
		TickUpper:                200,
