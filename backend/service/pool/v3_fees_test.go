...
func TestCalcV3UnclaimedFeesFromGrowthsRejectsInconsistentSnapshot(t *testing.T) {
	pos := &blockchain.V3PositionInfo{
		TickLower:                100,
		TickUpper:                200,
...
func TestCalcV3UnclaimedFeesFromGrowthsRejectsInsideGreaterThanGlobal(t *testing.T) {
	pos := &blockchain.V3PositionInfo{
		TickLower:                100,
		TickUpper:                200,
		Liquidity:                big.NewInt(10),
