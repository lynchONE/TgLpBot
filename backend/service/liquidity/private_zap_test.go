...
func TestPrivateZapCacheKey_NormalizesChain(t *testing.T) {
	...
	want := "private_zap:binding:v6:base:123:zap_simple"
	if key != want {
...
func TestPrivateZapCacheScanPattern_NormalizesChain(t *testing.T) {
	...
	want := "private_zap:binding:v6:bsc:*"
	if pattern != want {
...
func TestPrivateContractCacheKey_AtomicIndependentPrefix(t *testing.T) {
	...
	want := "private_atomic_increase_zap:binding:v6:base:123:atomic_increase_zap"
	if key != want {
