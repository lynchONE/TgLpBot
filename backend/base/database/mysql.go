...
func autoMigrate() error {
	...
	ensureColumn("sm_wallet_midnight_snapshots", "open_lp_usd", "DECIMAL(20,4) NOT NULL DEFAULT 0 AFTER tracked_token_usd")
	ensureColumn("sm_wallet_midnight_snapshots", "tracked_token_count", "INT NOT NULL DEFAULT 0 AFTER total_usd")
	ensureColumn("sm_wallet_midnight_snapshots", "active_pool_count", "INT NOT NULL DEFAULT 0 AFTER tracked_token_count")
	...
	ensureColumn("global_configs", "alpha_airdrop_reminder_enabled", "TINYINT(1) NOT NULL DEFAULT 0 AFTER extra_notifications_enabled")
	ensureColumn("global_configs", "alpha_airdrop_reminder_minutes", "INT NOT NULL DEFAULT 3 AFTER alpha_airdrop_reminder_enabled")
